...
[下载cli模板](https://vkceyugu.cdn.bspapp.com/VKCEYUGU-f5b1722f-8766-40af-a22a-acc454202a37/98c54373-d4d6-494b-8d8e-57a43d7c7a75.zip)
...
2. 解压cli模板。复制出src目录，把src目录名称改下，改成你的项目名称，就是一个新的项目了
    无需npm install。因为最新的hbx4.14是内置了模块
